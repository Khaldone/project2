...
namespace CBS
{
...
#endif
    {
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs purchaseEvent)
        {
            ...
            // Defensive check: Only validate purchases that were initiated through CBS.
            // This prevents KeyNotFoundException when using a custom AAA StoreOrchestrator pipeline.
            if (ResultList != null && ResultList.ContainsKey(product.definition.id))
            {
        ...
        public void OnPurchaseFailed(Product product, PurchaseFailureReason failureReason)
        {
            ...
            // Defensive check for custom AAA pipelines
            if (ResultList == null || !ResultList.ContainsKey(productID)) return;
