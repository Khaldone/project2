...
public class CueShopLifetimeScope : LifetimeScope
{
    ...
    private void Start()
    {
        ...
        if (this.Parent != null && this.Parent.Container != null)
        {
            ...
            // =========================================================
            Cue_ShopScreen cueMenu = null;
            foreach (var root in rootObjects)
            {
                cueMenu = root.GetComponentInChildren<Cue_ShopScreen>(true);
                if (cueMenu != null) break;
            }

            if (cueMenu != null)
            {
                sharedRouter.RegisterMenu(cueMenu);
            ...
            foreach (var root in rootObjects)
            {
                var navHandlers = root.GetComponentsInChildren<CueShop_NavHandler>(true);
